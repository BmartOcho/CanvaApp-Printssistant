...
export function App() {
  ...
  async function clearGuides() {
    ...
    try {
      ...
      setStatus("Clearing all overlays…");
      ...
      setStatus("Error clearing overlays.");
  ...
  async function applyGuides() {
    ...
    try {
      ...
      // Note: Overlays are no longer cleared automatically.

      // Use the "Clear All" button to reset the view.
  ...
  async function addRoundedCorners() {
    ...
    try {
      ...
      setStatus("Error adding corners.");
    ...
    <Box padding="2u">
      ...
      <Rows spacing="2u">
        ...
        <Box direction="row" spacing="1u">
          ...
          <Button variant="secondary" onClick={clearGuides}>
